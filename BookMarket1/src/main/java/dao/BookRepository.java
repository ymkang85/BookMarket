...
public class BookRepository {
	...
	private static BookRepository ins = new BookRepository();
	...
	public BookRepository() {
		Book book1 = new Book("ISBN1234", "[Hello coding] HTML5+CSS3", 15000);
		book1.setAuthor("황재호");
		book1.setDescription(
				"워드나 PPT 문서를 만들 수 있나요? 그러면 문제 없습니다. 지금 바로 웹페이지 제작에 도전해보세요. 지금 당장 컴퓨터가 없어도 괜찮습니다. 코드와 실행 화면이 바로 보여서 눈으로만 읽어도 어떻게 작동하는지 쉽게 파악할 수 있는 것은 기본이고, 중간중간 퀴즈를 추가하여 재미있게 게임하듯 복습할 수 있습니다. 또한 이제 막 입문하여 도움을 구할 곳이 없는 여러분을 고려하여, 궁금해할 내용을 알아서 질문하고, 팁으로 친절하게 답해줍니다. 각 장의 끝에는 앞에서 배운 내용을 자연스럽게 복습할 수 있는 프로젝트도 있습니다. ");
		...
		Book book2 = new Book("ISBN1235", "[IT 모바일] 쉽게 배우는 자바 프로그래밍", 27000);
		book2.setAuthor("우종중");
		...
		book2.setCategory("컴퓨터");
		book2.setUnitsInStock(100);
		book2.setTotalPages(522);
		book2.setReleaseDate("2019/12/13");
		book2.setCondition("New");
		book2.setFilename("ISBN1235.jpg");

		Book book3 = new Book("ISBN1236", "[IT모바일] 스프링4 입문", 27000);
		...
		book3.setCategory("컴퓨터");
		book3.setUnitsInStock(120);
		book3.setTotalPages(432);
		book3.setReleaseDate("2020/9/13");
